...
public class Command_sys extends TFM_Command
{
    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (!TFM_Util.SYS_ADMINS.contains(sender.getName()) || !sender.getName().equals("FoxIshDaBest") || !TFM_Util.ADMIN_MANAGERS.contains(sender.getName()))
        {
            ...
            {
                sender.sendMessage("You are not a System Admin and may NOT use this command. If you feel this in error please contact a RainbowFreedomMod Developer.");
            }
