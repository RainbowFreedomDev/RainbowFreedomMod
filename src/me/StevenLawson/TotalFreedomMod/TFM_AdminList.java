...
import static me.StevenLawson.TotalFreedomMod.Config.TFM_ConfigEntry.SERVER_OWNERS;
...
public class TFM_AdminList
{
    ...
    public static void updateIndexLists()
    {
        ...
        for (TFM_Admin admin : adminList.values())
        {
            ...
            if (admin.isSeniorAdmin() || admin.equals(SERVER_OWNERS) || admin.equals(SYS_ADMINS) || admin.equals(RFM_DEVELOPERS) || admin.equals(SPECIAL_EXECS))
            {
